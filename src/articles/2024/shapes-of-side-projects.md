...
Every side project tutorial ends the same way: "Now deploy it and start charging users!" As if the only valid outcome is a business.

But most satisfying side projects never ship to anyone but yourself.
...
Before starting, ask: what does success look like for this project?

- Learning → Done when you understand
- Tool → Done when it solves your problem
- Portfolio → Done when it's presentable
- Sketch → Done when the idea is explored
- Product → Never done
