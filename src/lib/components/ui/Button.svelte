<script lang="ts">
	...
	const baseClasses =
		'inline-flex items-center justify-center rounded-lg font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed';
...
<button class={combinedClasses} {...buttonProps}>
	{@render children?.()}
</button>
