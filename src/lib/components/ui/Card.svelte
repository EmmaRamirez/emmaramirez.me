...
>
	{#if header}
		<div class="px-4 py-3 border-b border-[var(--liver-brown-500)] bg-[var(--sandy-tan-400)]">
			{@render header()}
		</div>
	{/if}
	...
	{#if footer}
		<div class="px-4 py-3 border-t border-[var(--liver-brown-500)] bg-[var(--sandy-tan-400)]">
			{@render footer()}
		</div>
	{/if}
</div>
