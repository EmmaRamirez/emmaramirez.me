	...
	<span
		class={cn(
			...
			isDark
				...
				: "translate-x-0 bg-(--liver-brown-700)"
		)}
	>
		{#if isDark}
			<svg class="w-3 h-3 text-(--page-bg)" fill="currentColor" viewBox="0 0 20 20">
				<path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"/>
			</svg>
		{:else}
			<svg class="w-3 h-3 text-(--sandy-tan-200)" fill="currentColor" viewBox="0 0 20 20">
