<script lang="ts">
    ...
    let path = $state<string>('M384 160C480.5 29.5003 362.893 -35.6147 307 21.0001C251.107 77.6149 -105.864 177.507 31.5682 280.004C169 382.5 287.5 290.5 384 160Z');
...
<svg class={className} width="421" height="324" viewBox="0 0 421 324" fill="none" xmlns="http://www.w3.org/2000/svg" >
