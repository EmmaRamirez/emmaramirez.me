	...
	const mockArticlesByTag: Record<string, Article[]> = {
		philosophy: [
			{
				...
				content:
					'As much as web design is a visual medium both restrained and bolstered by technological innovations...',
				date: '2024-12-01',
				tags: ['philosophy', 'design']
			},
			{
				id: 'dialectics-of-ux',
				title: 'The Dialectics of UX',
				content:
					'Thesis: Users want simplicity. Antithesis: Users want power. Synthesis: Progressive disclosure.',
				date: '2024-06-15',
				tags: ['philosophy', 'ux']
			}
		],
		design: [
			...
			},
			{
				...
				content:
					'What happens when a design system escapes the comfy confines of Figma and lands in production?',
				date: '2024-09-22',
				tags: ['design', 'systems']
			},
			{
		...
		web: [
			{
				...
				content:
					'Personal websites are an act of rebellion against the homogenization of the web...',
				date: '2024-11-15',
				tags: ['web', 'personal']
			},
			{
		...
		rust: [
			{
				...
				content: 'Learning Rust has been a journey of both frustration and enlightenment...',
				date: '2024-10-28',
		...
		svelte: [
			{
				...
				content: 'Runes represent a fundamental shift in how Svelte handles reactivity...',
				date: '2024-10-10',
		...
		frontend: [
			{
				...
				content: 'Three days without Wi-Fi forced me to diagram every component by hand.',
				date: '2024-09-05',
		...
		css: [
			{
				...
				content: 'Grid has turned layout from a chore into a small act of poetry.',
				date: '2024-08-18',
				tags: ['css', 'layout']
			},
			{
...
<Drawer {open} {onclose} width="26.25rem">
	{#snippet header()}
		<div>
			<span class="font-mono text-xs tracking-wider text-[var(--liver-brown-500)] uppercase"
				>Articles tagged</span
			>
			<h2
				class="flex items-center gap-2 font-serif text-2xl font-bold text-[var(--liver-brown-700)]"
			>
				<span
					class="rounded-full bg-[var(--sandy-tan-500)] px-3 py-1 font-mono text-sm tracking-wider text-[var(--liver-brown-700)] uppercase"
				>
					{tag}
				</span>
			</h2>
	...
	{#if articles.length === 0}
		<div class="py-12 text-center text-[var(--liver-brown-500)]">
		...
		<div class="space-y-4">
			{#each articles as article (article.id)}
				...
				>
					...
					<p class="mb-3 line-clamp-2 text-sm text-[var(--liver-brown-600)]">{article.content}</p>
					<div class="flex items-center justify-between gap-2">
						<div class="flex flex-wrap gap-1">
							{#each article.tags || [] as articleTag (articleTag)}
								<span
									class="rounded-full px-2 py-0.5 font-mono text-[0.625rem] tracking-wider uppercase {articleTag.toLowerCase() ===
									tag.toLowerCase()
										? 'bg-[var(--liver-brown-500)] text-[var(--sandy-tan-100)]'
										: 'bg-[var(--sandy-tan-400)] text-[var(--liver-brown-600)]'}"
								>
									{articleTag}
								</span>
							{/each}
						...
						{#if article.date}
							<time class="font-mono text-xs whitespace-nowrap text-[var(--liver-brown-500)]">
